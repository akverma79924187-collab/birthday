  ...
  return (
    <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto flex flex-col justify-between">
      <div>
        ...
        <div className="relative max-w-3xl mx-auto flex flex-col items-center justify-center min-h-[500px]">
          <AnimatePresence mode="wait">
            {!isOpen ? (
              ...
              <motion.div
                ...
                className="cursor-pointer group relative w-full sm:w-[500px] h-72 sm:h-80 rounded-3xl bg-gradient-to-tr from-[#241c38] via-[#372b54] to-[#241c38] border-2 border-[#e6ca85]/40 p-8 flex flex-col items-center justify-between shadow-[0_20px_60px_rgba(0,0,0,0.8)] hover:border-[#e6ca85] transition-all hover:scale-105"
              >
                {/* Envelope Flap Vector Shape */}
                <div className="absolute top-0 inset-x-0 h-36 bg-gradient-to-b from-[#2e2348] to-[#241c38] clip-polygon border-b border-[#e6ca85]/30 rounded-t-3xl flex items-center justify-center">
                  {/* Wax Seal Badge */}
                  <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-[#df95a6] via-[#c44e66] to-[#df95a6] border-2 border-[#e6ca85] shadow-[0_0_25px_#df95a6] flex items-center justify-center text-white font-serif-display font-bold text-2xl group-hover:rotate-12 transition-transform">
                    <Heart className="w-8 h-8 fill-current" />
                  </div>
                </div>

                <div className="mt-auto pt-24 text-center space-y-2">
                  <span className="font-serif-display text-2xl font-bold text-gold-gradient block">
              ...
              <motion.div
                ...
                className="relative w-full glass-panel rounded-3xl p-8 sm:p-14 border border-[#e6ca85]/40 shadow-2xl bg-gradient-to-b from-[#141022] via-[#1a152b] to-[#141022] space-y-8"
              >
                {/* Ambient stamp icon */}
